#ifndef ALIENHACK_GAME_TYPE_MENU_HPP
#define	ALIENHACK_GAME_TYPE_MENU_HPP
...
class GameTypeMenu : public RL_shared::InterfaceState
{
public:

	GameTypeMenu( boost::weak_ptr< RL_shared::InterfaceStateMachine > ism, boost::shared_ptr< RL_shared::IFunctionMap > keys );
